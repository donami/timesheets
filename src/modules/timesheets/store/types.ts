...
const FETCH_TIMESHEET_TEMPLATES_IF_NEEDED =
  'FETCH_TIMESHEET_TEMPLATES_IF_NEEDED';
...
const UPDATE_TIMESHEET_TEMPLATE = createRequestTypes(
  'UPDATE_TIMESHEET_TEMPLATE'
);
const REMOVE_TIMESHEET_TEMPLATE = createRequestTypes(
  'REMOVE_TIMESHEET_TEMPLATE'
);
